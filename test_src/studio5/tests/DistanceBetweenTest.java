...
public class DistanceBetweenTest {
	...
	public void testIdenticalPoints() {
		...
		assertEquals(0.0, // The value we expect to get (to pass the test)
				Methods.distance(1.0, 0.0, 1.0, 0.0), // The thing to test
	...
	public void testPointsA() {
		...
		assertEquals(1.0, Methods.distance(1.0, 0.0, 2.0, 0.0), 1e-5);
	}
	...
	public void testPointsB() {
		...
		assertEquals(2.0, Methods.distance(0.0, 1.0, 0.0, -1.0), 1e-5);
	}
	...
	public void testPointsC() {
		...
		assertEquals(5.0, Methods.distance(-1.0, -1.0, 2.0, 3.0), 1e-5);
	}
	...
	public void testPointsD() {
		...
		assertEquals(50.0, Methods.distance(0.0, 30.0, 0.0, 40.0), 1e-5);
	}
